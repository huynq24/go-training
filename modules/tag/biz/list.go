...
type ListTagStore interface {
	ListDataWithCondition(context context.Context, condition map[string]interface{}, filter *tagmodel.Filter, paging *common.Paging, moreKeys ...string) ([]tagmodel.Tag, error)
}
